...
DocumentReference? get currentUserReference =>
    loggedIn ? UserinformationRecord.collection.doc(currentUser!.uid) : null;

UserinformationRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserinformationRecord.getDocument(
                  UserinformationRecord.collection.doc(uid))
              .handleError((_) {}),
    )
